...
```
[ ]  1. RoutineImporter: add <textarea> + "Import from text" button                       (2-3h)
[ ]  2. WorkoutScreen header: routine name as <h1>, day label as <p>                       (10m)
[ ]  3. SetSlot: bg-success + white text for logged; min 48×64; border-cta on focus       (30m)
[ ]  4. ExerciseCard: remove `uppercase` from names; vertical-stack last-time + suggest   (30m)
[ ]  5. Global: p-4 → p-5 baseline across feature screens; space-y-4 between cards        (30m)
...
[ ] 10. CLAUDE.md: 391 → 440 tests (and note drift)                                        (5m)
[ ] 11. Component tests: WorkoutScreen, SetLogSheet, SettingsScreen, TodayScreen          (3d)
