...
export function FinishCelebration({
  ...
  return (
    <button
      ...
      className="fixed inset-0 z-[80] flex flex-col items-center justify-center gap-4 bg-accent-cli p-8 text-background animate-[fadeIn_var(--dur-fadeIn)_var(--ease-handoff)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-inset focus-visible:ring-background/40"
    >
