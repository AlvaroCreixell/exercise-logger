...
class SetChip(ButtonBehavior, MDBoxLayout):
    ...
    v2: Only three set_kind values — reps_weight, time, cardio.
    Exercise type comes from the parent card, not from the set itself.
    """
